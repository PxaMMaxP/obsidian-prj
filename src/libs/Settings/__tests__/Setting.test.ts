...
describe('SettingItem', () => {
    ...
    it('should instantiate SettingItem correctly', () => {
        const settingItem = new SettingRow(
            undefined,
            undefined,
            containerEl,
            mockComponent,
    ...
    it.skip('should configure the SettingItem correctly', () => {
        ...
        const item = new SettingRow(mockModal, configure);
        item.load();
        expect(configure).toHaveBeenCalled();
    });

    it('should throw error if add method fails to instantiate setting field', () => {
        const settingItem = new SettingRow(mockModal);
    ...
    it('should set the class correctly', () => {
        ...
        expect(settingItem.settingRowEl.classList.contains(className)).toBe(
            true,
        );
    });
    ...
    it('should set the class array correctly', () => {
        ...
        expect(settingItem.settingRowEl.classList.contains(className[0])).toBe(
            true,
        );

        expect(settingItem.settingRowEl.classList.contains(className[1])).toBe(
            true,
        );
    });
    ...
    it('should append elements correctly using LazzyLoading', () => {
        ...
        expect(settingItem.settingRowEl).toBeDefined();
    ...
    it.skip('should add setting field correctly', () => {
        ...
        class MockSettingField {
            ...
            constructor(settingItem: SettingRow) {
